...
// Gets full information in JSON format from the OpenWeather API. Uses latitude and 
// longitude as taken from the MySQL database.

  $url = "https://api.openweathermap.org/data/2.5/onecall?lat=" .$latitude. "&lon=" .$longitude. "&units=imperial&appid=88745dd2f98a47cb6e28861a890809cf";
