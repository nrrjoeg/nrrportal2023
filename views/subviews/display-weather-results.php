<div class="content-container">
     ...
     <div class="headerbox">
       <?php echo $itemtext. "&ensp; Latitude &ensp;" .$latitude. '&ensp; Longitude &ensp;' . $longitude; ?>
     </div>


      <?php //Set the default timezone to UTC to get the local time calls for weather.
         date_default_timezone_set("UTC"); ?>
         
   <div class="time-and-date-container">

      <?php $currenttime = time()+($utcdiff*60*60); //Get full timestamp + time difference
            echo "Local time: " .date("l Y-F-d H:i:s", $currenttime); ?>
   </div>
    ...
    <div class="resultbox">
       ...
       <div class="place-image-container">
         <img src="<?php echo $imagedir. '/' .$imagefile ?>" width="600px">
      </div>
    ...
    <div class="place-image-container">
      <img src="<?php echo $imagedir.'/' .$mapfile ; ?>" width="750px" alt="<?php echo $itemtext ; ?>">
   </div>