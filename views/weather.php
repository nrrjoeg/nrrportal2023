...
<?php require_once $processdir.'/get-headtags/get-weather-headtags.php'; ?>
    ...
    <?php require_once $processdir.'/get-current-weather.php'; ?>

  <div class="content-container">

     <div class="headerbox">
       <?php echo "Current Sarasota Weather: Lat &ensp;" .$json['lat']. '&ensp; Long &ensp;' . $json['lon'];  ?>
     </div>
    ...
    <div class="resultbox">
       ...
       <table>
         ...
         <div class="place-image-container">
            <img src="https://i.pinimg.com/originals/fe/46/8d/fe468dd6d910791235f7cea9c5bf59c5.jpg" width="600px" alt="Ringling Bridge">
         </div>
