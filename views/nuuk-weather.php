...
<?php require_once $processdir.'/get-headtags/get-weather-headtags.php'; ?>
    ...
    <?php require_once $processdir.'/get-current-nuuk-weather.php'; ?>

  <div class="content-container">

     <div class="headerbox">
       <?php echo "Currently in Nuuk, Greenland: Latitude &ensp;" .$json['lat']. '&ensp; Longitude &ensp;' . $json['lon'];  ?>
     </div>
    ...
    <div class="resultbox">
       ...
       <table>
         ...
         <div class="place-image-container">
            <img src="https://guidetogreenland.com/wp-content/uploads/2020/04/Downtown-nuuk-at-dusk-with-store-malene-in-the-background-Guide-to-Greenland-1024x683.jpg" width="600px" alt="Nuuk Greenland">
         </div>
