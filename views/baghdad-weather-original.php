...
<?php require_once $processdir.'/get-headtags/get-weather-headtags.php'; ?>
    ...
    <?php require_once $processdir.'/get-current-baghdad-weather.php'; ?>

  <div class="content-container">

     <div class="headerbox">
       <?php echo "Currently in Baghdad Iraq: Latitude &ensp;" .$json['lat']. '&ensp; Longitude &ensp;' . $json['lon'];  ?>
     </div>
...
<table>
   ...
   <tr><th>Sunset Tonight</th><td><?php echo date('H:i', $localsunset );?></td></tr>
       ...
       <div class="place-image-container">
            <img src="https://mediad.publicbroadcasting.net/p/shared/npr/styles/x_large/nprshared/201805/484563379.jpg" width="600px" alt="Fairbanks Alaska">
         </div>
