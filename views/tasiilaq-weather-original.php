...
<?php require_once $processdir.'/get-headtags/get-weather-headtags.php'; ?>
  ...
  <div class="content-container">
     ...
     <div class="headerbox">
       <?php echo "Currently in " .$itemtext. "&ensp; Latitude &ensp;" .$latitude. '&ensp; Longitude &ensp;' . $longitude; ?>
     </div>
    ...
    <div class="place-image-container">
      <img src="<?php echo $imagedir.'/' .$mapfile ; ?>" width="750px" alt="Tassilaq Greenland">
   </div>
